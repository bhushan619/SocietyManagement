...
$(function() {
	...
	//select2
	$("#e1, #e2, #bds, #ContentPlaceHolder1_ddlFeature, #ContentPlaceHolder1_ddlParkingSlots, #ContentPlaceHolder1_ddlReportto , #ContentPlaceHolder1_ddlProperty, #ContentPlaceHolder1_ddlSocOrVen").select2({ width: '100%' });
