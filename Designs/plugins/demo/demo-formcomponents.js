...
$(function() {
	...
	//select2
	$("#e1, #e2, #bds, #ContentPlaceHolder1_ddlFeature, #ContentPlaceHolder1_ddlParkingSlots, #ContentPlaceHolder1_ddlReportto , #ContentPlaceHolder1_ddlProperty").select2({ width: '100%' });
