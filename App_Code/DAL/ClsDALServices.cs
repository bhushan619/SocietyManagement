...
{
    public class ClsDALServices : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public ClsDALServices()
        {
            ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionStringServices"].ToString();          
        }
