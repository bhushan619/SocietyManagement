...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_Vendor` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_VendorById` (IN `spintVendorCode` TEXT)  BEGIN
...
(1, 'Bhushan Savale688', '956142148945', NULL, 'savalebd@gmail.com', 'true', 'Jalgaon', '123', '6575757', 'prabhat', '1', '15', '334', 0, '1', '1 appcion.png', NULL, NULL, NULL),
...
(4, 'Suhas Bhave', '9850153115', NULL, 'Laukikbhave9@gmail.com', '13171', NULL, 'pluscity', NULL, NULL, NULL, NULL, NULL, 0, '0', 'Noprofile.png', NULL, NULL, NULL),
(5, 'jyoti', '9561421489', NULL, 'jyotipatil612@hotmail.com', 'true', NULL, '123', NULL, NULL, NULL, NULL, NULL, 0, '1', 'Noprofile.png', NULL, NULL, NULL);
...
(1, 'SKSSI4606782', 1, 'SKSV2274028', '93194', '2016-07-05', '2016-07-16', '3PM to 5PM', 1, 15, 334, 'Jalgaon', 0, '0', '0', 'Pending', 'NA', 'Pending', 'NA', 'Started', NULL, NULL, NULL, NULL),
(2, 'SKSSI6568638', 1, 'SKSV2274028', '93194', '2016-07-05', '2016-07-13', '1PM to 3PM', 1, 15, 334, 'Jalgaon', 0, '0', '0', 'Pending', 'NA', 'Pending', 'NA', 'Completed', NULL, NULL, NULL, NULL);
...
(1, 0, '2016-07-21', '00:00:00', ''),
(2, 0, '2016-07-22', '00:00:03', ''),
(3, 0, '2016-07-23', '00:00:01', ''),
(4, 0, '2016-07-26', '00:00:05', ''),
(5, 0, '2016-07-20', '00:00:01', ''),
(6, 0, '2016-07-12', '00:00:01', ''),
(7, 0, '2016-07-13', '00:00:03', ''),
(8, 0, '2016-07-20', '00:00:05', ''),
(9, 0, '2016-07-07', '00:00:03', ''),
(10, 0, '2016-07-23', '00:00:03', ''),
(11, 0, '2016-07-15', '00:00:01', ''),
(12, 0, '2016-07-22', '00:00:03', ''),
(13, 0, '2016-07-22', '00:00:03', ''),
(14, 0, '2016-07-13', '00:00:01', ''),
(15, 0, '2016-07-16', '00:00:03', '');
...
(34, 'SKSSI2433943', 'SKSV5756797', 1, 4, 'fgfgd', 1, 0, '2016-07-05');
...
(2, 'SKSV2274028', 'Gargi Sales and Services', 'Snehal Ghosalkar', '9422567297', '9923586924', 'savalebd@gmail.com', 1, 15, 334, 'Plot No. 53, Mundada Nagar, Jalgaon', 'Mundada Nagar', '425001', 'savalebd@gmail.com', '123', '2016-06-21 00:00:00', 1, 1, NULL, NULL),
...
(1, 'SKSV9346489', 'We Clean Your Any Type Of Tanks', 'NoProfile.png'),
...
(3, 'SKSV7792611', 'We shape the wooden goods..', 'NoProfile.png'),
(4, 'SKSV4336372', 'All Electrical work and Plumbing', '4 auti (1).jpg'),
(5, 'SKSV6804863', 'All types of Electrical works', 'NoProfile.png'),
...
(16, 'SKSV8505861', 'Electrical Works', 'NoProfile.png'),
...
(20, 'SKSV3119111', 'Plumbing Services', 'NoProfile.png'),
...
(24, 'SKSV3433544', 'herbal pest spray commercial and residential', 'NoProfile.png'),
(25, 'SKSV1717326', 'General disinfestation Cockroach control Rodent control Bedbugs control Fleas control Anti termite treatment', 'NoProfile.png'),
(26, 'SKSV994219', 'Bedbag Cockroach Tarmait Ends Lezard Mousekuyto honey rat and other', 'NoProfile.png'),
...
--
ALTER TABLE `tblorderhistory`
  MODIFY `intId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `tblreviews`
--
ALTER TABLE `tblreviews`
  MODIFY `intId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT for table `tblvendor`
--
ALTER TABLE `tblvendor`
  MODIFY `intId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
