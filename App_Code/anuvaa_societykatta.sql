...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2016 at 09:05 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetNavigationMenus` (IN `inUserId` INT, IN `inFeatureId` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetParentMenuByUserId` (IN `inUserId` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetReportParentMenusByUserId` (IN `inUserId` INT)  BEGIN
    SELECT A.FeatureId,FMC.FeatureName,A.PageName,A.SortOrder
    FROM featuresmaster A
      INNER JOIN featuresmasterculturemap FMC ON FMC.FeatureId=A.FeatureId
      INNER JOIN rolefeaturesmap C ON C.FeatureId = A.FeatureId
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Delete_VendorService` (IN `spintServiceCode` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Delete_VendorServiceSubType` (IN `spintServicesubtypeCode` INT)  BEGIN

DELETE FROM `tblvendorservicesubtype` WHERE intServicesubtypeCode=spintServicesubtypeCode ;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Delete_VendorServiceType` (IN `spintServicetypeCode` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Feature` (IN `spFeatureName` TEXT, IN `spParentId` INT, IN `spPageName` TEXT, IN `spCreatedBy` INT, IN `spCultureId` INT, IN `spIsActive` TINYINT, IN `rValue` INT, IN `spisSubMenu` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Invoice` (IN `varOrderNo` TEXT, IN `varDateTime` TEXT, IN `intFromSocietyId` TEXT, IN `intFromRole` TEXT, IN `intFromId` TEXT, IN `varSubTotal` TEXT, IN `varDiscount` TEXT, IN `varTax` TEXT, IN `varOther` TEXT, IN `varTotal` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Role` (IN `spDeptId` INT(10), IN `spCreatedBy` INT(10), IN `spIsActive` TINYINT(1), IN `spRoleName` TEXT, IN `spCultureId` INT(10), IN `rValue` INT(10), IN `spSocietyId` TEXT)  IF EXISTS (SELECT        tblmasterdepartment.varDepartmentName, rolesmasterculturemap.RoleName AS Expr2
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_RoleFeaturesMap` (IN `spRoleId` INT, IN `spFeatureId` INT, IN `spIsCreate` INT, IN `spIsRead` INT, IN `spIsUpdate` INT, IN `spIsDelete` INT, IN `varSocietyId` TEXT, IN `spIsActive` INT)  BEGIN
declare rValue int;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_Title` (IN `spCreatedBy` INT, IN `spIsActive` INT, IN `spTitleName` TEXT, IN `spCultureId` INT, IN `rValue` INT, IN `spsocietyid` TEXT)  IF EXISTS (SELECT * FROM `titlemasterculturemap` WHERE `TitleName`= spTitleName and varSocietyid=spsocietyid  LIMIT 1) THEN 
 set rValue=0;
   ELSE 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_VendorService` (IN `spServiceCode` INT, IN `spName` TEXT, IN `spDescription` TEXT, IN `spVisitingFee` TEXT, IN `spRemark` TEXT, IN `spCreatedBy` TEXT, IN `spIsActive` TEXT, IN `spvarImage` TEXT, IN `rValue` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_VendorServiceSubType` (IN `spintServicesubtypeCode` INT, IN `spSevicetypeCode` INT, IN `spServiceCode` INT, IN `spName` TEXT, IN `spPrice` TEXT, IN `spDescription` TEXT, IN `spRemark` TEXT, IN `spCreatedBy` TEXT, IN `spIsActive` TEXT, IN `rValue` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_VendorServiceType` (IN `spServicetypeCode` INT, IN `spServiceCode` INT, IN `spName` TEXT, IN `spDescription` TEXT, IN `spRemark` TEXT, IN `spCreatedBy` TEXT, IN `spIsActive` TEXT, IN `rValue` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_SelectUserName` ()  BEGIN
SELECT        CONCAT(FirstName,' ',  MiddleName,' ',FamilyName) AS Username,UserId
FROM    users WHERE  users.IsActive = 1  ;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_Feature` (IN `spintRoleId` TEXT)  BEGIN
SELECT DISTINCT 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_MenuFromFeature` (IN `spParentId` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_PropertyDetailsByWhere` (IN `spwhere` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_Role` (IN `spSocietyId` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_RoleByDepartmentId` (IN `spDeptId` INT, IN `spAdminId` TEXT)  BEGIN
SELECT      (SELECT `varDepartmentName` FROM `tblmasterdepartment` WHERE `intId`=rolesmaster.DeptId  ) As Department, rolesmasterculturemap.RoleName,  rolesmaster.CreatedDate, rolesmaster.CreatedBy, rolesmaster.IsActive, rolesmaster.RoleId,
                         rolesmasterculturemap.CultureId
FROM            rolesmaster INNER JOIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_RoleFeaturesMap` (IN `spvarSocietyId` LONGTEXT, IN `spAdminId` LONGTEXT, IN `spPropertyId` LONGTEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Select_SocietyPersonnelFullDetail_By_WhereCondi` (IN `spwhere` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_SubMenuFromFeature` (IN `spintRoleId` LONGTEXT, IN `spParentMenuId` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_Title` (IN `spSocietyId` TEXT)  SELECT        titlemaster.TitleId, titlemaster.CreatedDate, titlemaster.CreatedBy, titlemaster.IsActive, titlemasterculturemap.TitleName
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Select_UserProfile` (IN `spUserId` INT)  BEGIN
SELECT       * FROM            users
WHERE        (UserId = spUserId);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_Users_By_SocietyId` (IN `spSocietyId` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_VendorService` (IN `spIsActive` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_VendorServiceById` (IN `spintServiceCode` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_VendorServiceSubType` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_VendorServiceSubTypeById` (IN `spintServicesubtypeCode` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_VendorServiceType` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_VendorServiceTypeById` (IN `spintServicetypeCode` INT)  BEGIN
SELECT        tblvendorservices.varName AS Service, tblvendorservicestype.intId, tblvendorservicestype.intServicetypeCode, tblvendorservicestype.intServiceCode, 
                         tblvendorservicestype.varName AS Type, tblvendorservicestype.varDescription, tblvendorservicestype.varRemark, tblvendorservicestype.CreatedDate, 
                         tblvendorservicestype.CreatedBy, tblvendorservicestype.varIsActive
FROM            tblvendorservices INNER JOIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_VendorServiceTypeByService` (IN `spServiceCode` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Update_UserProfileByUserId` (IN `spUserId` INT, IN `spTitleId` INT, IN `spFirstName` TEXT, IN `spMiddleName` TEXT, IN `spFamilyName` TEXT, IN `spDisplayName` TEXT, IN `spUserImage` TEXT, IN `spEmailAddress` TEXT, IN `spFax` TEXT, IN `spCountryCode` TEXT, IN `spPhoneNumber` BIGINT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Update_UserProfileByUserIdFromAdmin` (IN `spUserId` INT, IN `spTitleId` INT, IN `spFirstName` TEXT, IN `spMiddleName` TEXT, IN `spFamilyName` TEXT, IN `spDisplayName` TEXT, IN `spUserImage` TEXT, IN `spEmailAddress` TEXT, IN `spFax` TEXT, IN `spCountryCode` TEXT, IN `spPhoneNumber` BIGINT, IN `spUsername` TEXT, IN `spIsActive` INT, IN `spRoleId` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Update_VendorService` (IN `spServiceCode` INT, IN `spName` TEXT, IN `spDescription` TEXT, IN `spRemark` TEXT, IN `spVisitingFee` TEXT, IN `spIsActive` TEXT, IN `spvarImage` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Update_VendorServiceSubType` (IN `spServicesubtypeCode` INT, IN `spServicetypeCode` INT, IN `spServiceCode` INT, IN `spName` TEXT, IN `spPrice` TEXT, IN `spDescription` TEXT, IN `spRemark` TEXT, IN `spIsActive` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Update_VendorServiceType` (IN `spServicetypeCode` INT, IN `spServiceCode` INT, IN `spName` TEXT, IN `spDescription` TEXT, IN `spRemark` TEXT, IN `spIsActive` TEXT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `StoredProcedure1` ()  BEGIN
...
(1, 'SKS647980', 'SKSE8173711', 1, 'bhushan', '111111111111111', 'sbi', 1, '2222', '3333', 'jjjjhjhj', 'midc, jalgaon', '2016-07-15', 'SKSE8173711', 1, '', '', '', '', '');
...
(1, 'SKS647980', 'SKSE8173711', 1, '1', '2016-07-14', '05:55:10', 'voice polution problem', 'voice polution problem', 'New', '', '0000-00-00', 1, '', '', '', '', '');
...
(4, 'SKSI3889054', 'NA', '2016-07-15', 'SKS647980', 1, 'SKSE8173711', '5100', 'NA', 'NA', 'NA', '5100', '', '', '', '', '', '', ''),
(5, 'SKSI5188889', 'NA', '2016-07-15', 'SKS647980', 1, 'SKSE8173711', '2342', 'NA', 'NA', 'NA', '2342', '', '', '', '', '', '', ''),
(6, 'SKSI4946807', 'NA', '2016-07-15', 'SKS647980', 1, 'SKSE8173711', '150', 'NA', 'NA', 'NA', '150', '', '', '', '', '', '', ''),
(7, 'SKSI6990255', 'NA', '2016-07-15', 'SKS647980', 1, 'SKSE8173711', '444', 'NA', 'NA', 'NA', '444', '', '', '', '', '', '', ''),
(8, 'SKSI6527006', 'NA', '2016-07-15', 'SKS647980', 1, 'SKSE8173711', '444', 'NA', 'NA', 'NA', '444', '', '', '', '', '', '', '');
...
(7, 'SKSI3889054', 'amount for something', 'NA', '5100', '', '', '', '', '', '', ''),
(8, 'SKSI5188889', 'ddd', 'NA', '2342', '', '', '', '', '', '', ''),
(9, 'SKSI4946807', 'ddff', 'NA', '150', '', '', '', '', '', '', ''),
(10, 'SKSI6990255', 'hhh', 'NA', '444', '', '', '', '', '', '', ''),
(11, 'SKSI6527006', 'hhh', 'NA', '444', '', '', '', '', '', '', '');
...
(4, 'SKS647980', 'SKSI3889054', 2, 'SKSP9993416', '0', '5100', 'Pending', '0', 'Started', 'NA', 'Started', '', '', '', ''),
(5, 'SKS647980', 'SKSI5188889', 2, 'SKSP3139651', '0', '2342', 'Pending', '0', 'Started', 'NA', 'Started', '', '', '', ''),
(6, 'SKS647980', 'SKSI4946807', 2, 'SKSP3139651', '0', '150', 'Pending', '0', 'Started', 'NA', 'Started', '', '', '', ''),
(7, 'SKS647980', 'SKSI6990255', 2, 'SKSP3139651', '0', '444', 'Pending', '0', 'Started', 'NA', 'Started', '', '', '', ''),
(8, 'SKS647980', 'SKSI6527006', 2, 'SKSP3139651', '0', '444', 'Pending', '0', 'Started', 'NA', 'Started', '', '', '', '');
...
(1, 'SKS647980', 1, '1 BHK', '', '', '2016-07-14', 1, 1, '', '', '', '', ''),
...
(1, 'SKS647980', 'Level-1', '', '', '2016-07-14', 1, 1, '', '', '', '', ''),
...
(1, 'SKS647980', 'Flat', '', '', '2016-07-14', 1, 1, '', '', '', '', ''),
...
(1, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSP9993416', 2, 'New Invoice Generated by ', '', '', 'Unread', '', '2016-07-14 00:00:00', '', ''),
(2, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSP3139651', 2, 'New Invoice Generated by ', '', '', 'Unread', '', '2016-07-14 00:00:00', '', ''),
(3, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSP3139651', 2, 'New Invoice Generated by ', '', '', 'Unread', '', '2016-07-14 00:00:00', '', ''),
(4, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSE8173711', 1, 'New Compliants Uploaded by Bhushan Savale-Admin', '', '', 'Unread', '', '2016-07-14 00:00:00', '', ''),
(5, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSP9993416', 2, 'New Invoice Generated by ', '', '', 'Unread', '', '2016-07-15 00:00:00', '', ''),
(6, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSP3139651', 2, 'New Invoice Generated by ', '', '', 'Unread', '', '2016-07-15 00:00:00', '', ''),
(7, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSP3139651', 2, 'New Invoice Generated by ', '', '', 'Unread', '', '2016-07-15 00:00:00', '', ''),
(8, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSP3139651', 2, 'New Invoice Generated by ', '', '', 'Unread', '', '2016-07-15 00:00:00', '', ''),
(9, 'SKS647980', 'text', 'SKSE8173711', 1, 'SKSP3139651', 2, 'New Invoice Generated by ', '', '', 'Unread', '', '2016-07-15 00:00:00', '', '');
...
(2, 'SKSP3139651', 'SKS647980', 2, 2, 1, 2, '2', 'Paresh Patil', 'Male', '2', '', '9561421489', '9561421489', '', 'savalebd@gmail.com', '', 'SKSP3139651', '123', '2016-07-14', 'SKSE8173711', 1, 'NoProfile.png', 'http://', 'http://', 'http://', '', '', '', '');
...
(1, 'SKS647980', 'SKSP9993416', '1', '', '', '', '', 'SKSE8173711', 1, '2016-07-14', '', '', '', '', ''),
...
(4, 'SKS647980', 'SKSE8173711', '1', 'Good Thoughts', '', '86931 study-motivation-hacks.jpg', '2016-07-14', 'SKSE8173711', 1, '', '', '', '', '');
...
(1, 'SKS647980', 'SKSE8173711', 1, 1, 1, 'Bhushan Savale', '', '', '', '', '0001-01-01', '0001-01-01', '', '9403910390', '', '', '', '', '', 1, 15, 338, '', '', '', 'savalebd@gmail.com', 'admin@societykatta.com', '123', '', '', '', '', 'NoProfile.png', 1, '1', '2016-07-14', '', '', '', '', '', '', '', '', '', ''),
...
INSERT INTO `tblsuperadmin` (`intId`, `varUsername`, `varPassword`, `varDesignation`) VALUES
(1, 'societykatta@gmail.com', 'm', 'admin');
...
--
ALTER TABLE `rolesmaster`
  MODIFY `RoleId` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
