<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/outside.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Home_Login" %>
							...
							<div class="form-block center-block p-30 light-gray-bg border-clear">
								...
								<div class="form-horizontal">
                                    ...
                                    <div class="form-group has-feedback">
										...
										<div class="col-sm-8">
                                           <asp:DropDownList ID="ddlUserType" CssClass="form-control" runat="server" required="required">
                                               <asp:ListItem Value="">:: Select User Type ::</asp:ListItem>
                                               <asp:ListItem Value="1">Society User</asp:ListItem>
                                               <asp:ListItem Value="2">Services User</asp:ListItem>
