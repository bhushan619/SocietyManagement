<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/outside.master" AutoEventWireup="true" CodeFile="SVendorProfile.aspx.cs" Inherits="Home_SVendorProfile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">	<!-- main-container start -->
			<!-- ================ -->
						...
						<div class="main col-md-12">
							...
							<div class="row">
								...
								<div class="col-md-8 ">								
                                    ...
                                    <div class="form-group has-feedback">
										...
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtName" placeholder="Name" runat="server" CssClass="form-control" required="required"  onkeyup="checkText(this);"></asp:TextBox>   
                                            <i class="fa fa-user form-control-feedback"></i>
										</div>
									</div>
                                                  <div class="form-group has-feedback">
										<label for="inputUserName" class="col-sm-3 control-label">Contact Person</label>
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtcPerson" placeholder="Name" runat="server" CssClass="form-control" required="required"  onkeyup="checkText(this);"></asp:TextBox>   
                                            <i class="fa fa-user form-control-feedback"></i>
										</div>
									</div>
									<div class="form-group has-feedback">
                                    ...
                                    <div class="form-group has-feedback">
										...
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtlandline" placeholder="Landline" runat="server" CssClass="form-control"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" MaxLength="15"></asp:TextBox>   
                                            <i class="fa fa-mobile form-control-feedback"></i>
										</div>
                         ...
                         <div class="form-group">
									...
									<div class="col-sm-8">
										...
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtaddress" placeholder="Address" runat="server" CssClass="form-control" required="required"  onkeyup="checkTextNum(this);" ></asp:TextBox>   
                                            <i class="fa fa-map-marker form-control-feedback"></i>
										</div>
									</div>
                                                 <div class="form-group has-feedback">
										<label for="inputUserName" class="col-sm-3 control-label">Pincode</label>
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtpin" placeholder="Pincode" runat="server" CssClass="form-control"   onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"></asp:TextBox>   
                                            <i class="fa fa-map-marker form-control-feedback"></i>
										</div>
									</div>
                                                 <div class="form-group has-feedback">
										<label for="inputUserName" class="col-sm-3 control-label">About Bussiness</label>
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtabout" placeholder="About Myself" runat="server" Height="150"  onkeyup="checkTextNum(this);" CssClass="form-control" required="required" TextMode="MultiLine"></asp:TextBox>   
                                           
										</div>
									</div>
                                               
                                                <div class="form-group has-feedback">
										<label for="inputUserName" class="col-sm-3 control-label">Service Description</label>
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtdescription" placeholder="Service Description" Height="150"  onkeyup="checkTextNum(this);" runat="server" CssClass="form-control" required="required" TextMode="MultiLine"></asp:TextBox>   
                                           
										</div>
									</div>
                                                 <div class="form-group has-feedback">
										<label for="inputUserName" class="col-sm-3 control-label">Visiting Charges</label>
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtcharges" placeholder="Service Charges" runat="server" onkeyup="checkDec(this);" CssClass="form-control" required="required" ></asp:TextBox>   
										...
										<div class="col-sm-8">
                                           <asp:TextBox ID="txtusername" placeholder="Username" ReadOnly="true" runat="server" CssClass="form-control" required="required" ></asp:TextBox>   
                                            <i class="fa fa-user form-control-feedback"></i>
										</div>
									</div>
                                                  <%--  
