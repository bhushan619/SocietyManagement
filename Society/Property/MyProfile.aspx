<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Property.master" AutoEventWireup="true" CodeFile="MyProfile.aspx.cs" Inherits="Society_Property_MyProfile" %>
			...
			<div class="tab-content">
							...
							<div class="row">
                                                ...
                                                <h4>Contact Information</h4>
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="form-group">
											            ...
											            <div class="col-sm-8 tabular-border">
											             <asp:TextBox ID="txtAltMobileNos" runat="server" onkeyup="checkOtherMobWithSemicolon(this);"  CssClass="form-control"    ></asp:TextBox>
                                                      ...
                                                      <div class="form-group">
									                        ...
									                        <div class="col-sm-8 tabular-border">
										                               <asp:TextBox ID="txtAltEmailIds" onkeyup="validateEmails(this);"  runat="server" CssClass="form-control" placeholder="Alternate Email Ids Seprated By ';'"   ></asp:TextBox>
								...
								<li class="timeline-info">
											...
											<div class="timeline-body">
                                                <h4>Social Information</h4>
                                        	            <div class="form-group">
											                ...
											                <div class="col-sm-8 tabular-border">
                                                                <asp:TextBox ID="txtfb" runat="server" class="form-control" type="url"  pattern="^http(s?)\:\/\/[0-9a-zA-Z]([-.\w]*[0-9a-zA-Z])*(:(0-9)*)*(\/?)([a-zA-Z0-9\-\.\?\,\'\/\\\+&amp;%\$#_]*)?$"></asp:TextBox>
                                        	...
                                        	<div class="form-group">
											    ...
											    <div class="col-sm-8 tabular-border">
												         <asp:TextBox ID="txtgoogle" runat="server" class="form-control"  type="url" pattern="^http(s?)\:\/\/[0-9a-zA-Z]([-.\w]*[0-9a-zA-Z])*(:(0-9)*)*(\/?)([a-zA-Z0-9\-\.\?\,\'\/\\\+&amp;%\$#_]*)?$" ></asp:TextBox>
                                        	...
                                        	<div class="form-group">
											    ...
											    <div class="col-sm-8 tabular-border">
												         <asp:TextBox ID="txttwitter" runat="server" class="form-control"  type="url"  pattern="^http(s?)\:\/\/[0-9a-zA-Z]([-.\w]*[0-9a-zA-Z])*(:(0-9)*)*(\/?)([a-zA-Z0-9\-\.\?\,\'\/\\\+&amp;%\$#_]*)?$"></asp:TextBox>
                                        ...
                                        <h4>Profile Photo</h4>
                                            <div class="form-group">
                                                 ...
                                                 <div class="form-group"> 
                                                        ...
                                                        <div id="divMessage" class="col-sm-4" runat="server"><asp:Label id="lblMessage" runat="server" /></div>
                                                </div>
                                            <script type="text/javascript">
                ...
                <div class="tab-pane" id="tab-timeline">
					<div class="panel">
                      ...
                      <div id="divMessage1" class="col-sm-4" runat="server"><asp:Label id="lblMessage1" runat="server" /></div>
                    </div>
                                        </div>
                                    </div>
