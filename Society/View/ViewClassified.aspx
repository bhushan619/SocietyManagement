<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Society.master" AutoEventWireup="true" CodeFile="ViewClassified.aspx.cs" Inherits="Society_View_ViewClassified" %>
                    ...
                    <asp:ListView ID="lstreply" runat="server" DataKeyNames="intId" >
                        ...
                        <ItemTemplate>
                            <span class="table-responsive">     
                               <table class="table">
                                   <tr>
                                       <td> Advertiser :</td><td> <asp:Label Text='<%# Eval("Name") %>' runat="server" ID="NameLabel" /> </td>
                                   </tr>
                                  ...
                                  <tr><td> Country</td><td> <asp:Label Text='<%# Eval("CountryName") %>' runat="server" ID="CountryNameLabel" /></td></tr>
                                   ...
                                   <tr><td>Image</td><td> <asp:Image ID="imgSimilarPic" runat="server" CssClass="fancybox" Height="50px" Width="50px"   ImageUrl='<%# "~/Society/Media/Classified/" + Eval("varClassifiedImage	") %>' /></td></tr>
                                   <tr><td></td><td></td></tr>
                               </table>
