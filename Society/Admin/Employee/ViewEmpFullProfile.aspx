<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="ViewEmpFullProfile.aspx.cs" Inherits="Society_Admin_Employee_ViewEmpFullProfile" %>
			...
			<div class="panel panel-profile">
			  ...
			  <div class="panel-body">
			    ...
			    <ul class="list-inline text-center">
                    ...
                    <li><asp:HyperLink runat="server" ID="HyperLink1" NavigateUrl="~/Society/Admin/Employee/ViewEmpolyee.aspx" class="profile-back-icon " ><i class="ti ti-back-left"></i></asp:HyperLink></li>
			    </ul>
			  </div>
			</div><!-- panel -->
								      ...
								      <table class="table about-table">
								        <tbody>
								          <tr><th>Full Name
								              ...
								              </th> <td> <asp:Label ID="lblpFullName" runat="server" Text=""></asp:Label>
								          ...
								          <tr>
								            <th>Address</th>
								            <td>
                                                <asp:Label ID="lblpAddress" runat="server" Text=""></asp:Label></td>
								          </tr>
				...
				<div class="tab-pane" id="tab-photos">
				 ...
				 <div class="tab-pane" id="tab-edit">
					<div class="panel">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12 table-responsive">
									<div class="form-horizontal  table about-table">
                                        <ul class="timeline">
								        ...
								        <tbody>
										  ...
										  <tr><th>
											    <label for="form-name" class=" control-label">Gender</label>
											  </th><td>
                       ...
                       <tr><th>
									<label for="focusedinput" class="   control-label">Police Verification Number</label>
                                       
							 </th><td>
										         <asp:Label ID="txtPoliceVerify" runat="server" CssClass=""></asp:Label>
									 </td>

										      </tr>
                         
                       <tr><th><label for="focusedinput" class="   control-label">Marital Status</label>  </th><td>                 
									   ...
									   <tr><th><label for="focusedinput" class="   control-label">Father/Husband</label>  </th><td>    
											 
                                       
								
										       <asp:Label ID="txtFatherHusband" runat="server" CssClass=""></asp:Label>
									  </td> </tr>
									
								
									   <tr><th><label for="focusedinput" class="   control-label"> Spouse Name</label>  </th><td>      
							
										       <asp:Label ID="txtSpouse" runat="server" CssClass=""></asp:Label>
								  </td> </tr>
									
								
									                       <tr><th><label for="focusedinput" class="   control-label">Date Of Birth</label>  </th><td>    
                                                       									       
                                                                            <asp:Label ID="txtDOB" runat="server"  CssClass="" required="required"></asp:Label>	
                                                  
									  </td> </tr>
									
								               
									   <tr><th><label for="focusedinput" class="   control-label"> PAN Number</label>  </th><td>       
								
										          <asp:Label ID="txtPANNo" runat="server" CssClass=""></asp:Label>
								
									  </td> </tr>
									
								
									   <tr><th><label for="focusedinput" class="   control-label">PF Number</label>  </th><td>    
								
										         <asp:Label ID="txtPFNo" runat="server" CssClass=""></asp:Label>
									  </td> </tr>
									
							
									   <tr><th><label for="focusedinput" class="   control-label">ESI Number</label>  </th><td>    
								  <asp:Label ID="txtESINo" runat="server" CssClass=""></asp:Label>
								  </td> </tr>
								        ...
								        <tbody>
                                                    <tr><th>
											            <label for="form-name" class="   control-label">Mobile</label>
											         </th><td>   
                                                   ...
                                                   <tr><th>
											            <label for="form-name" class="   control-label">Other Mobile</label>
											             </th><td>   
											             <asp:Label ID="txtAltMobileNos" runat="server"   CssClass=""    ></asp:Label>
                                                           ...
                                                           <tr><th>
									                            <label for="focusedinput" class="     control-label">Primary Email-Id</label>
									                            </th><td>   
                                                     ...
                                                     <tr><th>
									                        <label for="focusedinput" class="     control-label">Other Email-Ids</label>
									                       </th><td>   
                                                 ...
                                                 <tr><th>
									<label for="focusedinput" class="     control-label">County</label>                                          
									 </th><td>   
										            <asp:Label ID="ddlCountry" runat="server" CssClass=""></asp:Label>
                                                </td></tr>
                        ...
                        <tr><th>
									<label for="focusedinput" class="     control-label">State</label>
										           ...
										           <asp:Label ID="ddlState" runat="server" CssClass="" ></asp:Label>
                                               </td></tr>	
                        <tr><th>
									<label for="focusedinput" class="     control-label">City</label>
									 </th><td>   
										         <asp:Label ID="ddlCity" runat="server" CssClass=""></asp:Label>
                                                
								
							</td></tr>
                        <tr><th>
									<label for="focusedinput" class="     control-label"> Pin/Zip Code</label>
									 </th><td>   
										               <asp:Label ID="txtPinZip" runat="server" CssClass=""></asp:Label>
											  </td> </tr>			
								
                         <tr><th>
											    <label for="form-name" class="   control-label">Address</label>
											  </th><td>   
                                                	      <asp:Label ID="txtaddress" runat="server" CssClass="" TextMode="MultiLine"></asp:Label>
                                                     </td> </tr>
										 
                          <tr><th>
									<label for="focusedinput" class="     control-label">Permanent  Address</label>
									 </th><td>   
										        <asp:Label ID="txtPermanentAddress" runat="server" CssClass="" TextMode="MultiLine"></asp:Label>
								...
								<li class="timeline-info">
								        ...
								        <tbody>
                                        	            <tr><th>
											                <label for="form-website" class="   control-label">Facebook Link</label>
											                </th><td> 
                                                                <asp:Label ID="txtfb" runat="server" class=""  ></asp:Label>
                                                       </td> </tr>  <tr><th>
											    <label for="form-website" class="   control-label">Google Plus Link</label>
											   </th><td>   
												         <asp:Label ID="txtgoogle" runat="server" class="" ></asp:Label>
                                                  </td> </tr>  <tr><th>
											    <label for="form-website" class="   control-label">Twitter Link</label>
											   </th><td>   
