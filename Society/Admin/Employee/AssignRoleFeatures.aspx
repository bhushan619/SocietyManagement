<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="AssignRoleFeatures.aspx.cs" Inherits="Society_Admin_Employee_AssignRoleFeatures" %>
		...
		<div class="col-md-6 ">
				...
				<div class="panel-body">
					<div  class="form-horizontal">
                        ...
                        <div class="form-group">
									<label for="focusedinput" class="col-sm-4   control-label">Select Department</label>
									<div class="col-sm-8">
         	 
									     <asp:DropDownList ID="ddlDepartment"  required="required" runat="server"  CssClass="form-control" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged" AutoPostBack="true">
            <asp:ListItem Value="">:: Select Department ::</asp:ListItem>
                           ...
                           <div class="form-group">
									...
									<div class="col-sm-8">
										 <asp:DropDownList ID="ddlRole"  required="required" AppendDataBoundItems="true" style="width: 100%;"  CssClass="form-control " runat="server">
            ...
            <asp:ListItem Value="0" >Inactive</asp:ListItem>
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AssignRoleFeatures.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
