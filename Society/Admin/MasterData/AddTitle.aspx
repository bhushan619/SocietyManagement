<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="AddTitle.aspx.cs" Inherits="Society_Admin_MasterData_AddTitle" %>
				...
				<div class="panel-body">
					<div  class="form-horizontal">
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AddTitle.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
                                                     ...
                                                     <ItemTemplate>
                                                         <tr style="">
                                                            ...
                                                            <td>  <asp:Label ID="lblSRNO" runat="server"  Text='<%#Container.DataItemIndex+1 %>'></asp:Label></td>
                                                             <td>
                                                                 <asp:Label Text='<%# Eval("TitleName") %>' runat="server" ID="TitleName" /></td>
                                                             <td>
                                                                 <asp:Label Text='<%# Eval("IsActive") %>' runat="server" ID="IsActive" /></td>
                                                           <td><asp:LinkButton  ID="lnkListEdit" CommandArgument='<%# Eval("TitleId") %>' CommandName="Edits"  runat="server"  CssClass=" fa fa-edit"/></td>
                                                     ...
                                                     <LayoutTemplate>
                                                                     ...
                                                                     <table runat="server" id="itemPlaceholderContainer" cellpadding="1" class="table table-bordered table-hover" >
                                                                         <tr id="Tr1" runat="server" class="info">
                                                                             ...
                                                                             <th id="Th3" runat="server">Title Name</th>
                                                                           <th id="Th4" runat="server">IsActive</th>
