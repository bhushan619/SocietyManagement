<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="AddFlatPremisesType.aspx.cs" Inherits="Society_Admin_MasterData_AddFlatPremisesType" %>
		...
		<div class="col-md-6 ">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2> Premises Type Information</h2>
				</div>
				<div class="panel-body">
					<div  class="form-horizontal">
                       <div class="form-group">
									<label for="focusedinput" class="col-sm-3   control-label">Unit Type</label>
									<div class="col-sm-8">
                        ...
                        <div class="form-group">
									<label for="focusedinput" class="col-sm-3   control-label">Premises Type</label>
									<div class="col-sm-8">
										<asp:TextBox ID="txtType" runat="server"   CssClass="form-control"  required="required"></asp:TextBox>
									</div>
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AddFlatPremisesType.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
