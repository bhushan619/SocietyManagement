<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="AddNoticeType.aspx.cs" Inherits="Society_Admin_MasterData_AddNoticeType" %>
				...
				<div class="panel-body">
					<div  class="form-horizontal">
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AddNoticeType.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
