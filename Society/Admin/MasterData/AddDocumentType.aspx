<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="AddDocumentType.aspx.cs" Inherits="Society_Admin_MasterData_AddDocumentType" %>
				...
				<div class="panel-body">
					<div  class="form-horizontal">
                        ...
                        <div class="form-group">
									...
									<div class="col-sm-8">
										<asp:TextBox ID="txtType" runat="server" onkeyup="checkText(this);" CssClass="form-control"  required="required"></asp:TextBox>
									</div>
                        	...
                        	<div class="form-group">
									...
									<div class="col-sm-8">
										 <asp:TextBox ID="txtRemark" onkeyup="checkTextNum(this);" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
									</div>
								</div>
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AddDocumentType.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
        ...
        <div class="col-md-6 ">
			...
			<div class="panel-heading">
				...
				<div class="panel-body no-padding  table-responsive">
                                                 ...
                                                 <asp:ListView ID="lstDocumentType" runat="server" OnPagePropertiesChanging="OnPagePropertiesChanging" OnItemCommand="lstDocumentType_ItemCommand" >
                 ...
                 <div class="panel-footer">
                     <div class="text-right">
                                                     ...
                                                     <asp:DataPager ID="DataPager1" runat="server"  PagedControlID="lstDocumentType" PageSize="10">
                                                          <Fields  >
