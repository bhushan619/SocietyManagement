<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="AddEventType.aspx.cs" Inherits="Society_Admin_MasterData_AddEventType" %>
		...
		<div class="col-md-6 ">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2> Event And Announcement Type Information</h2>
				</div>
				<div class="panel-body">
					<div  class="form-horizontal">
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AddEventType.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
