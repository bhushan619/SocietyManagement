<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="AddComplaintsType.aspx.cs" Inherits="Society_Admin_MasterData_AddComplaintsType" %>
		...
		<div class="col-md-6 ">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2> Complaint Type Information</h2>
				</div>
				<div class="panel-body">
					<div  class="form-horizontal">
                      
                        <div class="form-group">
									<label for="focusedinput" class="col-sm-3   control-label">Complaint Type</label>
									<div class="col-sm-8">
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AddComplaintsType.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
        ...
        <div class="col-md-6 ">
			...
			<div class="panel-heading">
				...
				<div class="panel-body no-padding  table-responsive">
                                                 ...
                                                 <asp:ListView ID="lstComplaintType" runat="server" OnPagePropertiesChanging="OnPagePropertiesChanging" OnItemCommand="lstComplaintType_ItemCommand" >
                 ...
                 <div class="panel-footer">
                     <div class="text-right">
                                                     ...
                                                     <asp:DataPager ID="DataPager1" runat="server"  PagedControlID="lstComplaintType" PageSize="10">
                                                          <Fields  >
