<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Society.master" AutoEventWireup="true" CodeFile="AddBankDetails.aspx.cs" Inherits="Society_Common_AddBankDetails" %>
		...
		<div class="col-md-6 ">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2> Bank Acocunt Information</h2>
				</div>
				<div class="panel-body">
					<div  class="form-horizontal">                     
                         ...
                         <div class="form-group">
									...
									<div class="col-sm-8">
										<asp:TextBox ID="txtbankname" onkeyup="checkText(this);" runat="server" CssClass="form-control"  required="required"></asp:TextBox>
									</div>
								</div>	
                          <div class="form-group">
									<label for="focusedinput" class="col-sm-4   control-label">Branch Name</label>
									<div class="col-sm-8">
										<asp:TextBox ID="txtBranchName" runat="server" onkeyup="checkTextNum(this);" CssClass="form-control"  ></asp:TextBox>
									</div>
									</div>
                                                       <div class="form-group">
									<label for="focusedinput" class="col-sm-4   control-label">Branch City</label>
									<div class="col-sm-8">
										<asp:TextBox ID="txtbranchaddress" runat="server" CssClass="form-control" onkeyup="checkText(this);" required="required"></asp:TextBox>
									</div></div>
                         <div class="form-group">
									<label for="focusedinput" class="col-sm-4   control-label">Account Holder Name</label>
									<div class="col-sm-8">
										<asp:TextBox ID="txtAcholder" runat="server" CssClass="form-control"  required="required" onkeyup="checkText(this);"></asp:TextBox>
									</div>
                              ...
                              <div class="form-group">
									...
									<div class="col-sm-8">
										<asp:TextBox ID="txtaccountno" runat="server" CssClass="form-control" onkeyup="checkTextNum(this);"  required="required"></asp:TextBox>
									</div>
									</div>
                                   <div class="form-group">
									<label for="focusedinput" class="col-sm-4   control-label">Account Type</label>
									<div class="col-sm-8">
										 <asp:DropDownList ID="ddlaccountype" runat="server" CssClass="form-control" required="required">
									...
									<div class="col-sm-8">
										<asp:TextBox ID="txtifsc" runat="server" CssClass="form-control" onkeyup="checkTextNum(this);"></asp:TextBox>
									</div>
									</div>
                                             <div class="form-group">
									<label for="focusedinput" class="col-sm-4   control-label"> MCIR Code</label>
									<div class="col-sm-8">
										<asp:TextBox ID="txtmcir" runat="server" CssClass="form-control" onkeyup="checkTextNum(this);" ></asp:TextBox>
									</div>
									</div>
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AddBankDetails.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
