<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Society.master" AutoEventWireup="true" CodeFile="Gallary.aspx.cs" Inherits="Society_Extras_Gallary" %>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div  class="form-horizontal">
                           ...
                           <div class="form-group">
									<label  for="inputPassword1" class=" col-sm-3 control-label">Gallary Image</label>
									<div class="col-sm-5">
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="Gallary.aspx" >Reset</a>
                                             </div> 	<div class="col-sm-4">
                                         <asp:Image ID="ImgProfile" CssClass="fileupload-preview thumbnail" style="width: 120px; height: 120px;float:none"  runat="server" ImageUrl="~/Society/Media/Gallary/NoProfile.png" />
                                       </div>
                                                 ...
                                                 <asp:ListView ID="lstType" runat="server" OnPagePropertiesChanging="OnPagePropertiesChanging" OnItemCommand="lstType_ItemCommand" >
                                                     ...
                                                     <ItemTemplate>
                                                         <tr style="">
                                                             ...
                                                             <td> <asp:Label Text='<%# Eval("varDescription") %>' runat="server" ID="Description" /></td>
                                                                <td>   <asp:Image ID="imgSimilarPic" runat="server" CssClass="fancybox" Height="50px" Width="50px"   ImageUrl='<%# "~/Society/Media/Gallary/" + Eval("varGallaryImage") %>' /> </td> 
                                                                     ...
                                                                     <table runat="server" id="itemPlaceholderContainer" cellpadding="1" class="table table-bordered table-hover" >
                                                                         <tr id="Tr1" runat="server" class="info">
                                                                             ...
                                                                             <th id="Th4" runat="server">Description</th>
                                                                                <th id="Th6" runat="server">Image</th>
