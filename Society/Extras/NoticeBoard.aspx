<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Society.master" AutoEventWireup="true" CodeFile="NoticeBoard.aspx.cs" Inherits="Society_Extras_NoticeBoard" %>
				...
				<div class="panel-body">
					...
					<div  class="form-horizontal">
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="NoticeBoard.aspx" >Reset</a>
									</div>
								</div>
