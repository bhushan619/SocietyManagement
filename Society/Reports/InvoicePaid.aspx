<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Society.master" AutoEventWireup="true" CodeFile="InvoicePaid.aspx.cs" Inherits="Society_Reports_InvoicePaid" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <%--<asp:ListView ID="lstInvoicepaid" runat="server"  DataKeyNames="intId" OnSorting="lstInvoicepaid_Sorting">
        ...
        <ItemTemplate>
            <tr style="">
                <td>
                    <asp:Label Text='<%# Eval("intId") %>' runat="server" ID="intIdLabel" /></td>
                <td>
                    <asp:Label Text='<%# Eval("varSocietyId") %>' runat="server" ID="varSocietyIdLabel" /></td>
                <td>
                    <asp:Label Text='<%# Eval("intRoleId") %>' runat="server" ID="intRoleIdLabel" /></td>
                <td>
                    <asp:Label Text='<%# Eval("varPersonnelId") %>' runat="server" ID="varPersonnelIdLabel" /></td>
            </tr>
        </ItemTemplate>
        <LayoutTemplate>
            <table runat="server">
                    ...
                    <td runat="server">
                        <table runat="server" id="itemPlaceholderContainer" class=" table table-bordered" style="" border="0">
                            <tr runat="server" style="">
                                <th runat="server">Id&nbsp;<asp:ImageButton ID="imEmpID" CommandArgument="intId" CommandName="Sort" Text="Id" ImageUrl="~/Designs/Outside/images/asc.png" runat="server" /></th>
                                <th runat="server">SocietyId</th>
                                <th runat="server">RoleId</th>
                                <th runat="server">PersonnelId&nbsp;<asp:ImageButton ID="imEmpName" CommandArgument="varPersonnelId" CommandName="Sort"  ImageUrl="~/Designs/Outside/images/asc.png" Text="PersonnelId" runat="server" /></th>
                            </tr>
   ...
   <div class="row">
			...
			<div class="panel-heading">
				<h2><i class="ti  ti-home"></i>Flatwise Paid Invoices Details </h2>
