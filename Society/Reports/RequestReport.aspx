<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Society.master" AutoEventWireup="true" CodeFile="RequestReport.aspx.cs" Inherits="Society_Reports_RequestReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="row">
			...
			<div class="panel-heading">
				<h2><i class="ti  ti-comments-smiley"></i>View Request Report </h2>
					...
					data-action-colorpicker=''>
						                    ...
						                    <div class="panel-body table-responsive"> 
                                                  <div class="row"> 
                                                         ...
                                                         <asp:RadioButton ID="rgbNew" OnCheckedChanged="rgbNew_CheckedChanged" AutoPostBack="true" runat="server" Text="New Request" CssClass="radio-inline" GroupName="g"/>
                                                 <asp:RadioButton ID="rgbProceed" OnCheckedChanged="rgbNew_CheckedChanged" runat="server" AutoPostBack="true" CssClass="radio-inline" Text="Approve Request" GroupName="g"/> 
                                                         <asp:RadioButton ID="rgbResolved" OnCheckedChanged="rgbNew_CheckedChanged" runat="server" AutoPostBack="true" CssClass="radio-inline" Text="Reject Request" GroupName="g"/>
                                                              <asp:RadioButton ID="rgball" OnCheckedChanged="rgbNew_CheckedChanged" runat="server" AutoPostBack="true" CssClass="radio-inline" Text="All Request" GroupName="g"/>
