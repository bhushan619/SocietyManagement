<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SKAdminMaster.master" AutoEventWireup="true" CodeFile="MyProfile.aspx.cs" Inherits="SK_Employee_MyProfile" %>
		...
		<div class="col-sm-3">
			<div class="panel panel-default panel-profile">
			  ...
			  <div class="panel-body">
                    ...
                    <asp:Image ID="ImgProfile" CssClass="fileupload-preview  img-circle " Height="140px" Width="140px"   runat="server" ImageUrl="~/SK/Media/ProfilePhoto/NoProfile.png" />
			    <div class="name">
                                        ...
                                        <h4>Profile Photo</h4>
                                            <div class="form-group">
                                            	    ...
                                            	    <div class="col-sm-4 text-right">
                                                         <asp:Image ID="imguploadpic" CssClass="fileupload-preview thumbnail" style="width: 120px; height: 120px;float:none"  runat="server" ImageUrl="~/SK/Media/ProfilePhoto/NoProfile.png" />
                                                     </div>
                                                </div>
                                                <div class="form-group"> 
