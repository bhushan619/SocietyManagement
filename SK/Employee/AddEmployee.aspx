<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SKAdminMaster.master" AutoEventWireup="true" CodeFile="AddEmployee.aspx.cs" Inherits="SK_Employee_AddEmployee" %>
					...
					<div  class="form-horizontal">
                      <div class="col-md-6 ">
                        <div class="form-group">
									...
									<div class="col-sm-8">
										<asp:DropDownList ID="ddlEmpType"   runat="server" CssClass="form-control"  required="required">
                        ...
                        <div class="col-md-6 ">
                         ...
                         <div class="form-group">
                            ...
                            <div class="form-group">
									<label for="focusedinput" class="col-sm-4   control-label"> Primary Email-Id/Username</label>
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="AddEmployee.aspx" >Reset</a>
                                         ...
                                         <asp:Image ID="ImgProfile" CssClass="fileupload-preview thumbnail" style="width: 120px; height: 120px;float:none"  runat="server" ImageUrl="~/SK/Media/ProfilePhoto/NoProfile.png" />
                                       </div>
                                                         ...
                                                         <tr style="">
                                                             ...
                                                             <td>   <asp:Label Text='<%# Eval("varEmpName") %>' runat="server" ID="Type" /></td>
                                                               ...
                                                               <td>   <asp:Label Text='<%# Eval("varPrimaryEmail") %>' runat="server" ID="Label2" /></td>
                                                                <td>   <asp:Label Text='<%# Eval("varAddress") %>' runat="server" ID="Label3" /></td>
                                                           ...
                                                           <td><asp:LinkButton  ID="lnkListEdit" CommandArgument='<%# Eval("intId") %>' CommandName="Edits"  runat="server"  CssClass=" fa fa-edit" ToolTip="Edit Details"/></td>
                                                             <td><asp:LinkButton  ID="LinkButton1" CommandArgument='<%# Eval("intId") %>' CommandName="Delets"  runat="server"  CssClass=" fa fa-times" ToolTip="Delet Details"/></td>
                                                                     ...
                                                                     <table runat="server" id="itemPlaceholderContainer" cellpadding="1" class="table table-bordered table-hover" >
                                                                         <tr id="Tr1" runat="server" class="info">
                                                                             ...
                                                                             <th id="Th3" runat="server">Name</th> 
                                                                                ...
                                                                                <th id="Th7" runat="server">Address</th> 
