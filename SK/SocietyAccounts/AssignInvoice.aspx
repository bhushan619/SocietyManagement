<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SKAdminMaster.master" AutoEventWireup="true" CodeFile="AssignInvoice.aspx.cs" Inherits="SK_SocietyAccounts_AssignInvoice" %>
	...
	<div class="col-md-4 ">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2>Assign Invoice to Society Owners</h2>
				</div>
				<div class="panel-body">
					<div  class="form-horizontal">  
				 <div class="form-group">
									<label for="focusedinput"  control-label">Invoice For</label>
								 
										<asp:DropDownList ID="ddlInvoiceFor"  runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlInvoiceFor_SelectedIndexChanged"  required="required">
                               <asp:ListItem Value="">:: Select Invoice For ::</asp:ListItem>                                                      
                                            <asp:ListItem Value="1">Vendors</asp:ListItem>
                                            <asp:ListItem Value="2">Societys</asp:ListItem>
                           </asp:DropDownList>
        ...
        <div class="form-group">
									<label for="focusedinput"    control-label">All Or Multiple</label>
										...
										<asp:DropDownList  ID="ddlAllOrMultiple" Enabled="false"  runat="server" AutoPostBack="true" CssClass="form-control" OnSelectedIndexChanged="ddlAllOrMultiple_SelectedIndexChanged"  required="required">
                               <asp:ListItem Value="">:: Select All or Multiple ::</asp:ListItem>           
                           ...
                           <div class="form-group">
								<label for="focusedinput" class="control-label">Society/Vendors List</label>
								<select id="ddlSocOrVen" disabled="disabled" placeholder= ":: Select ::"  multiple="true" style="width:100% !important"   runat="server"   >
                                         </select> 
							</div>
				</div>
