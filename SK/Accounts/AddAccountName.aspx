<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SKAdminMaster.master" AutoEventWireup="true" CodeFile="AddAccountName.aspx.cs" Inherits="Society_Admin_Accounts_AddAccountName" %>
				...
				<div class="panel-body">
					<div  class="form-horizontal">
                        ...
                        <div class="form-group">
									...
									<div class="col-sm-8">
										  <asp:TextBox ID="txtAccountName" runat="server" CssClass="form-control"  onkeyup="checkTextNum(this);" placeholder="Account Name"></asp:TextBox>
									</div>
