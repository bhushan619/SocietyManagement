<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SKAdminMaster.master" AutoEventWireup="true" CodeFile="VendorServiceSubTypes.aspx.cs" Inherits="SK_MasterData_VendorServiceSubTypes" %>
		...
		<div class="col-md-6 ">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2> Service SubType Information</h2>
				</div>
				<div class="panel-body">
					<div  class="form-horizontal">
                      
                        <div class="form-group">
									<label for="focusedinput" class="col-sm-3   control-label">Service SubType Code</label>
									<div class="col-sm-8">
                          ...
                          <div class="form-group">
									...
									<div class="col-sm-8">
									 <asp:DropDownList  ID="ddlServiceType" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlServiceType_SelectedIndexChanged">
                          ...
                          <div class="form-group">
									<label for="focusedinput" class="col-sm-3   control-label">Service Type </label>
									<div class="col-sm-8">
									 <asp:DropDownList ID="ddlServiceMyType" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                    ...
                    <div class="form-group">
									<label for="inputPassword" class="col-sm-3   control-label">Price</label>
									<div class="col-sm-8">
										 <asp:TextBox ID="txtPrice" runat="server" onkeyup="checkTextNum(this);" CssClass="form-control"></asp:TextBox>
									</div>
								</div>
                        <div class="form-group">
                       ...
                       <asp:Button ID="btnSubmit" runat="server" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Submit" OnClick="btnSubmit_Click"  />
                          <a  class="mb-xs mt-xs mr-xs btn btn-primary" href="VendorServiceSubTypes.aspx" >Reset</a>
									</div>
								</div>
                          <div class="form-group"> 
			...
			<div class="panel-heading">
				...
				<div class="panel-body no-padding  table-responsive">
                                              ...
                                              <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand" OnPagePropertiesChanging="OnPagePropertiesChanging" >
                                                     ...
                                                     <ItemTemplate>
                                                         <tr style="">
                                                            <td><asp:LinkButton  ID="lnkListEdit" CommandArgument='<%# Eval("intServicesubtypeCode") %>' CommandName="Edits"  runat="server"  CssClass=" fa fa-edit"/></td>
                                                               <td><asp:LinkButton  ID="lnkListDelet" CommandArgument='<%# Eval("intServicesubtypeCode") %>' CommandName="Delets"  runat="server"  CssClass=" fa fa-trash-o"/></td>
                                                            <td>
                                                                 <asp:Label Text='<%# Eval("Service") %>' runat="server" ID="Service" /></td>
                                                             <td>
                                                                 <asp:Label Text='<%# Eval("Type") %>' runat="server" ID="Type" /></td>
                                                           <td>
                                                                 <asp:Label Text='<%# Eval("SubType") %>' runat="server" ID="SubType" /></td>
                                                             <td>
                                                                 <asp:Label Text='<%# Eval("varPrice") %>' runat="server" ID="varPrice" /></td>
                                                     ...
                                                     <LayoutTemplate>
                                                                     ...
                                                                     <table runat="server" id="itemPlaceholderContainer" cellpadding="1" class="table table-bordered table-hover" >
                                                                         <tr id="Tr1" runat="server" class="info">
                                                                             ...
                                                                             <th id="Th2" runat="server">Service</th>
                                                                             <th id="Th3" runat="server">Type</th>
                                                                              <th id="Th4" runat="server">SubType</th>
