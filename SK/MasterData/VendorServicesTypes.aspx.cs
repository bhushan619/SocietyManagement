...
public partial class SK_MasterData_VendorServicesTypes : ClsVendorServiceType
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (AddVendorServiceTypeDetails(Convert.ToInt32(txtMainCode.Text), Convert.ToInt32(ddlServiceType.SelectedValue), txtName.Text.Replace("'", "\\'"), txtDescription.Text.Replace("'", "\\'"), txtRemark.Text.Replace("'", "\\'"), 1, chkIsActive.Checked ? 1 : 0))
                {
    ...
    public void getServiceGridData()
    {
        try
        {
            ListView1.DataSource = FetchVendorServiceType();
            ListView1.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            if (UpdateVendorServiceTypeById(EditServiceTypeId, Convert.ToInt32(ddlServiceType.SelectedValue), txtName.Text.Replace("'", "\\'"), txtDescription.Text.Replace("'", "\\'"), txtRemark.Text.Replace("'", "\\'"), chkIsActive.Checked ? 1 : 0))
            {
